...
import {calculateBudgetMonth,nextMonth,validateMonth} from "./budgetMath";
...
describe("monthly budget calculations",()=>{
  ...
  it("validates and advances calendar months",()=>{expect(nextMonth("2026-12")).toBe("2027-01");expect(()=>validateMonth("2026-13")).toThrow("YYYY-MM");});
});
