...
class TauriFinanceRepository implements FinanceRepository {
  ...
  bulkUpdateTransactionStatus(input:BulkUpdateTransactionStatusInput):Promise<BulkMutationResult>{return invoke("bulk_update_transaction_status",{request:input});}
  bulkSetTransactionCategory(input:BulkSetTransactionCategoryInput):Promise<BulkMutationResult>{return invoke("bulk_set_transaction_category",{request:input});}
  bulkDeleteTransactions(input:BulkTransactionIdsInput):Promise<BulkMutationResult>{return invoke("bulk_delete_transactions",{request:input});}
  ...
  updateTransactionAnnotation(id: string, input: TransactionAnnotationInput): Promise<Transaction> { return invoke("update_transaction_annotation", { transactionId: id, request: input }); }
  ...
  createOrdinaryInvestmentCashTransfer(input: CreateTransferInput): Promise<CrossDomainCashTransferResult> { return invoke("create_ordinary_investment_cash_transfer", { request: input }); }
  updateOrdinaryInvestmentCashTransfer(id: string, input: CreateTransferInput): Promise<CrossDomainCashTransferResult> { return invoke("update_ordinary_investment_cash_transfer", { transferId: id, request: input }); }
  deleteOrdinaryInvestmentCashTransfer(id: string): Promise<void> { return invoke("delete_ordinary_investment_cash_transfer", { transferId: id }); }
