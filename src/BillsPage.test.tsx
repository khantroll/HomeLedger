...
const templates:ScheduledTransaction[]=[
  {id:"bill",kind:"transaction",accountId:"checking",payee:"Electric Utility",category:"Utilities",amountMinor:-2500,status:"pending",frequency:"monthly",anchorDate:"2026-09-15",enabled:true},
