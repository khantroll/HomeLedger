...
export default function App() {
  ...
  const refresh = useCallback(async () => {
    try {
      const [nextAccounts, nextTransactions] = await Promise.all([repository.listAccounts(), repository.listTransactions()]);
      setAccounts(nextAccounts); setTransactions(nextTransactions); setError("");
