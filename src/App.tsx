    ...
    <Dialog title={account ? "Edit account" : "Add account"} onClose={onClose}>
      <form onSubmit={submit} className="entry-form">
        ...
        {!account && <fieldset className="starting-point"><legend>How do you want to start this account?</legend>
          ...
          {startingPoint==="current" && <label>Current cleared balance<input name="balance" inputMode="decimal" defaultValue="0.00" required/><small className="field-help">For credit cards and loans, enter what you owe as a negative amount (for example, -1250.00).</small></label>}
