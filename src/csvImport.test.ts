...
import { buildPreview, normalizeDate, parseDelimited, parseStatementMoney, suggestMapping } from "./csvImport";
...
describe("local delimited statement parser", () => {
  ...
  it("maps, normalizes, and identifies duplicates", () => {
    ...
    expect(rows[0]).toMatchObject({ postedDate:"2026-09-01", amountMinor:-1234, duplicate:false });
