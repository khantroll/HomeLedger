...
describe("finance repository contract", () => {
  ...
  it("saves, updates, and deletes reusable import profiles",async()=>{
    ...
    const input={name:"Credit Union CSV",accountId:account.id,headerSignature:"date\u001fdescription\u001famount",sourceKind:"delimited" as const,sourceSignature:"credit union activity",dateColumn:0,payeeColumn:1,amountColumn:2,debitColumn:-1,creditColumn:-1,dateOrder:"mdy" as const,numberFormat:"dot" as const};
